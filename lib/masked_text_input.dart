...
class MoneyMaskedTextController extends TextEditingController {
  ...
  double get numberValue {
    if (this.text.isEmpty)
      return 0.0;
    if ((this.text.length - 1) < leftSymbol.length)
      return 0.0;

    if ((this.text.length - 1) < rightSymbol.length)
      return 0.0;
...
String moneyRupiah(double initialValue) {
...
String moneyRupiah0(double initialValue) {
  return MoneyMaskedTextController(
    initialValue: initialValue,
    thousandSeparator: '.',
    decimalSeparator: '',
